...
- PIT entries can still grow from periodic beacon insertion patterns if not matched; decay cleanup only removes PIT keys tied to evicted gradient entries.
